...
describe('DocumentsService', () => {
  ...
  describe('findAllTemplates', () => {
    it('should return all templates', async () => {
      mockPrismaService.documentTemplate.findMany.mockResolvedValue([mockTemplate]);
  ...
  describe('getOrCreatePortfolio', () => {
    it('should return existing portfolio', async () => {
      ...
      mockPrismaService.documentPortfolio.findUnique.mockResolvedValue(mockPortfolio);
