              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{center.certifier.razonSocial}</p>
                  </div>
                </div>
              </Link>
            </section>
          ...
          <div className="rounded-lg border bg-card p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">{center.ecStandards.length}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              {hasCoordinates && (
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono text-xs">
                    {center.latitud?.toFixed(4)}, {center.longitud?.toFixed(4)}
                  </span>
                </div>
              )}
            </div>
