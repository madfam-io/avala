        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <section className="rounded-lg border bg-card p-6">
              ...
              <div className="space-y-4">
                {ec.elementosJson.map((elemento: unknown, index: number) => {
                  const el = elemento as { titulo?: string; descripcion?: string };
                  return (
                    <div
                      key={index}
          ...
          <section className="rounded-lg border bg-card p-6">
            ...
            <div className="space-y-6">
              {/* Desempeño */}
              {Array.isArray(ec.critDesempeno) && ec.critDesempeno.length > 0 && (
                <div>
              ...
              {/* Conocimiento */}
              {Array.isArray(ec.critConocimiento) && ec.critConocimiento.length > 0 && (
                <div>
              ...
              {/* Producto */}
              {Array.isArray(ec.critProducto) && ec.critProducto.length > 0 && (
                <div>
